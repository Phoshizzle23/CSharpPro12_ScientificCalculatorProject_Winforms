...
namespace Sci_Cal
{
    public partial class Form1 : Form
    {
        ...
        {
            DialogResult exitCa1;
            exitCa1 = MessageBox.Show("Confirm if you want to exit", "Calculator", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            
            if (exitCa1 == DialogResult.Yes)
            {
                Application.Exit();
            }
